...
#ifndef BILIHARDCORE_AI_SWIFT_H
#define BILIHARDCORE_AI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="bilihardcore_ai",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15bilihardcore_ai11AppDelegate")
...
SWIFT_CLASS("_TtC15bilihardcore_ai17MainFlutterWindow")
